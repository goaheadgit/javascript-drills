...
favoriteThings['show'] = "Jane the Virgin";
...
function ingredients(obj){
  // const {carb: newCarb} = obj;
  // const {fat: newFat} = obj;
  // const {protein: newProtein} = obj;
...
let myCat = new Cat("Gracie", "2", "black")
...
let wiz1 = new Wizard("Harry", "12", "expelliarmus")
...
class Phone {
  constructor(brand, model, storage, color, price, sold){
    ...
    changePrice(newPrice){
      this.price = newPrice
      console.log(`Phone price is ${this.price}.`)
    }
}
let phone1 = new Phone("Apple", "iPhone", 32, "gold", "$20");
...
let phone2 = new Phone("Samsung", "3", 64, "black", 700);
let phone3 = new Phone("Google", "Pixel", 64, "white", 900);
