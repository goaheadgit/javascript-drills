...
const repeatMyParam = () => {
    ...
    .then(result => {return res.data});
    let repeatParam = getElementById('repeat-text')
    textContent = res.data
}
repeat-button.addEventListener('click', repeatMyParam)
...
query-button.addEventListener('click', myFunction)
